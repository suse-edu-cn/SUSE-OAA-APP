...
import com.suseoaa.projectoaa.ui.component.sukisu.liquid.InnerShadow
import com.suseoaa.projectoaa.ui.component.sukisu.liquid.innerShadow
import com.suseoaa.projectoaa.ui.component.sukisu.liquid.lens
import com.suseoaa.projectoaa.ui.component.sukisu.liquid.rememberCombinedBackdrop
import com.suseoaa.projectoaa.ui.component.sukisu.liquid.vibrancy
import com.suseoaa.projectoaa.ui.component.sukisu.miuix.animation.DampedDragAnimation
import com.suseoaa.projectoaa.ui.component.sukisu.miuix.animation.InteractiveHighlight
...
private fun rememberGravityRotatedHighlight(
    ...
    // [Optimization] Disable continuous device tilt sensor polling to prevent 
    // excessive GPU usage and phone heating when the device is idle.
    val rotatedPrimary = remember(baseStyle.primaryLight, extraDegrees) {
        val basePrimary = baseStyle.primaryLight
        
        // Static downward gravity vector instead of continuous sensor values
        val gx = 0f
        val gy = -1f
        ...
        // Apply rotation to light direction vector (lx0, ly0)
        val lx = lx0 * c - ly0 * s
        val ly = lx0 * s + ly0 * c
