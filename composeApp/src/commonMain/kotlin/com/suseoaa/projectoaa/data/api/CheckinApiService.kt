...
class CheckinApiService(private val httpClient: HttpClient) {
    ...
    companion object {
        ...
        // 登录服务地址
        private const val LOGIN_SERVICE = "$QFHY_BASE/site/appware/system/sso/login?target=$QFHY_BASE/xg/app/"
        ...
        // API 地址
        private const val USER_GROUPS_URL = "$QFHY_BASE/site/app/base/common/api/user/groups.rst?appCode=qddk"
        ...
        // RSA 密钥（固定值）
        const val RSA_MODULUS = ""
