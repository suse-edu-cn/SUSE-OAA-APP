...
class QrCodeCheckinApiService(private val httpClient: HttpClient) {
    ...
    companion object {
        ...
        private const val GROUP_IDENTITY_URL =
            "$QFHY_BASE/site/app/base/common/api/group/qddk/identity.rst"
        ...
        private const val CHECKIN_URL =
            "$QFHY_BASE/site/qddk/qdrw/api/checkSignLocationWithPhoto.rst"
    ...
    @Deprecated(
        "使用 getSsoSession() 代替",
        replaceWith = ReplaceWith("getSsoSession(sopSessionCookie, openId)")
    )
